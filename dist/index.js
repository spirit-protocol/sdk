...
__export(index_exports, {
  ...
  DEFAULT_REVENUE_CONFIG: () => DEFAULT_REVENUE_CONFIG,
  DEFAULT_SPLIT_BPS: () => DEFAULT_SPLIT_BPS,
  MAINNET_ADDRESSES: () => MAINNET_ADDRESSES,
  SPIRIT_REGISTRY_ABI: () => SPIRIT_REGISTRY_ABI,
...
function getAddresses2(chainId) {
...
var SpiritClient = class {
  ...
  constructor(config) {
    ...
    this.addresses = { ...getAddresses2(config.chainId) };
    if (config.contracts) {
   ...
   */
  async getRevenueConfig(agentId) {
   ...
   */
  async hasSpiritAttached(agentId) {
    return await this.publicClient.readContract({
      address: this.addresses.SpiritRegistry,
      abi: SPIRIT_REGISTRY_ABI,
   ...
   */
  async updateTreasury(agentId, newTreasury) {
    this.requireWallet();
    const { request } = await this.publicClient.simulateContract({
      address: this.addresses.SpiritRegistry,
      abi: SPIRIT_REGISTRY_ABI,
   ...
   */
  async getTreasuryBalance(agentId) {
