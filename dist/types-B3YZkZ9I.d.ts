...
declare const DEFAULT_REVENUE_CONFIG: RevenueConfig;
/**
...
interface RegisterSpiritParams {
...
interface RegisterSpiritResult {
...
interface SpiritRegisteredEvent {
    agentId: bigint;
    treasury: Address;
    artist: Address;
    platform: Address;
...
export { type Address as A, type BalanceInfo as B, DEFAULT_REVENUE_CONFIG as D, type Hash as H, type RevenueConfig as R, type SpiritClientConfig as S, type TreasuryUpdatedEvent as T, type SpiritAgent as a, type RegisterSpiritParams as b, type RegisterSpiritResult as c, type RouteRevenueParams as d, type RevenueEvent as e, type SpiritChainId as f, type SpiritRegisteredEvent as g, type RevenueRoutedEvent as h, type RegisteredEvent as i };
